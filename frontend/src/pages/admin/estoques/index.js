...
export default function EstoquesListagem() {
  ...
  async function handleDelete(id){
    if(window.confirm("Deseja realmente excluir este estoque?")){
      var result = await api.delete('/api/estoques/'+id);
                          ...
                          <TableBody>
                            {estoques.map((row) => (
                              ...
                              >
                                ...
                                <TableCell align="center">{row.descricao_estoque}</TableCell>
                                <TableCell align="center">{row.numeracao_estoque}</TableCell>

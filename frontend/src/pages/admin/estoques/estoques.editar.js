  ...
  const [nome, setNome] = useState('');
   ...
   useEffect(() => {
    async function getEstoque(){
      var response = await api.get('/api/estoques.details/'+idEstoque);
      console.log(response.data.idEstoque)
      
      setNome(response.data.nome_estoque);
      setDescricao(response.data.descricao_estoque);
      setNumeracao(response.data.numeracao_estoque);
      setQtd(response.data.qtd_estoque);
    }
   ...
   async function handleSubmit() {
     const data = {nome_estoque:nome, descricao_estoque:descricao, numeracao_estoque:numeracao, qtd_estoque:qtd, _id:idEstoque}

      if(nome!==''&&descricao!==''&&numeracao!==''&&qtd!==''){
        const response = await api.put('/api/estoques/', data)
